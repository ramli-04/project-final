...
$(document).ready(function() {
    ...
    $win.scroll(function() {
        if ($(this).scrollTop() > 42) {
            ...
            $('#WebDev-main-header').removeClass("sticky-nav");
        }
    });
    ...
    $("#WebDev-owl-slide-1").owlCarousel({
        loop: true,
        margin: 0,
        responsiveClass: true,
        items: 1,
    ...
    // Single Owl Slider
    $("#WebDev-owl-slide-2").owlCarousel({
        loop: true,
        responsiveClass: true,
        items: 1,
        nav: false,
    ...
    $("#WebDev-owl-slide-3").owlCarousel({
        loop: true,
        margin: 30,
        responsiveClass: true,
        items: 1,
    ...
    $("#WebDev-owl-slide-4").owlCarousel({
        loop: true,
        margin: 76,
        autoplay: true,
